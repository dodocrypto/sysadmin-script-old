...
# Change All destination directory and files to lower case.
# 
...
if (-d $_) {
## if it is directory , set old_filename to string
$old_file_name = $_;
print "$_\n";
...
### replace the current string to all lower case.
s/$temp/\L$temp\E/;
# turn off warnings
no warnings; {
### rename directorys to lower case
